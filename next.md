...
- 下一目标：按 `SRC-001` 至 `SRC-082` 提取旧资料；`SRC-001`、`SRC-002` 已完成，当前从 `SRC-003` `doc/requirements/teacher-platform-local-stage.md` 开始。机械归类由 Agent 自行处理，只有实质产品决策、冲突和归档动作提交人工判断。
