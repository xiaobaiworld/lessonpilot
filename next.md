...
- 生产 release 为 `20260821T014923Z-c0e8aaa94c27`，状态为 `verified`；
...
- 发布记录为 `deploy/releases/20260821T014923Z-c0e8aaa94c27.json`。
...
Nginx 同源反代均已验证。当前 release ID 为 `20260821T014923Z-c0e8aaa94c27`，对应
GitHub SHA `c0e8aaa94c27019c8b30d317cf800abcc89df84e`。生产 API 已完成登录、创建课程
