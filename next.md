...
Nginx 同源反代均已验证。当前 release ID 为 `20260820T142243Z-ec1454ed2f31`，对应
GitHub SHA `ec1454ed2f31512049069122406e8fbd387868b3`。生产 API 已完成登录、创建课程
和课节、保存四节点草稿、发布 `v1`、创建短期授权码和公开下载的完整探针。
