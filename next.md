...
Nginx 同源反代均已验证。当前 release ID 为 `20260820T153701Z-130b5ac22581`，对应
GitHub SHA `130b5ac225817dcb124bae89257da4efd1444e99`。生产 API 已完成登录、创建课程
和课节、保存四节点草稿、发布 `v1`、创建短期授权码和公开下载的完整探针；生产安全审计、
登录限速、锁定依赖、systemd 沙箱和每日 SQLite 备份也已部署并验证。
