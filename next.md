...
- 已接受：产品范围、领域术语、用户场景骨架、功能分解骨架、`FR-AUTH-*`、`FR-WS-*`、`FR-COURSE-*`、`FR-AUTHOR-*`、`FR-PUBLISH-*`、`FR-GRANT-*`、`FR-LIB-*`、`FR-RUNTIME-*`、`FR-LEARN-*` 和 `FR-ADMIN-*`。
- 下一目标：整理并逐段审核 `FR-PORT-*` 课程导入导出、本地文件与恢复。
