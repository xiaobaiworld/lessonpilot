...
| 04 | [`04-functional-requirements.md`](04-functional-requirements.md) | 按业务能力编号的功能性需求、业务规则和单项验收条件 | 已接受；已同步当前课程级最新版本授权，课程版本操作、版本级授权和后续升级兼容后置；新增 `FR-LIB-015`、`FR-LIB-016` 后续候选；`FR-REPORT` 保留为后续候选 |
