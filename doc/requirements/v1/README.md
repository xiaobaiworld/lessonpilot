...
| 03 | [`03-user-scenarios.md`](03-user-scenarios.md) | 用户角色、前置条件、主流程、异常流程和可观察结果 | 骨架及认证场景增补已接受；待后续需求反向补齐 |
| 04 | [`04-functional-requirements.md`](04-functional-requirements.md) | 按业务能力编号的功能性需求、业务规则和单项验收条件 | 第 1 段、`FR-AUTH`、`FR-WS` 已接受 |
