...
状态：场景骨架、`D-026` 单机边界、认证场景增补、视频重复范围澄清及 `SCN-TCH-07`
学习反馈与完成情况、`SCN-STU-05` 本地课程文件增补均已于 2026-08-21 通过人工审核；
当前不替代既有阶段需求或验收计划
...
| `SCOPE-09` 数据可携带与恢复 | `SCN-ADM-03`、`SCN-STU-05`（后续候选）、`SCN-ERR-02`；学习证据导出随 `SCN-TCH-07` 推迟 |
