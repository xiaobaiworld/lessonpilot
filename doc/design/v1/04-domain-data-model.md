...
| --- | --- | --- | --- |
| FastAPI + SQLite | 账号、会话、工作空间、课程、草稿（含教师保存的字幕原文）、课程发布快照（含字幕）、授权码、授权项、领取记录、操作审计、试用申请正文和跟进状态 | 有效资格、状态摘要 | 字幕进入课程包、申请正文进入普通日志/课程正文/学生数据、学生回答、学习进度、密码或授权码原文 |
...
（`DATA-PORT-003`、`D-V1-014`）；不包含 B 站播放视频或节点媒体文件本体、密码、会话、授权、学生数据或页面未保存内容。
