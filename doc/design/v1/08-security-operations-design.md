...
状态：已于 2026-08-22 通过人工审核；2026-08-27 按 `D-V1-018` 增补独立课程版本和版本级授权的安全边界；本文件把四类安全底线和第一阶段运行门禁落为最小可执行设计，不建设企业级安全平台
...
- 领取/更新只发送完成授权所需的本机标识、证明和独立课程版本意图；不发送完整字幕、课程运行状态、学生回答或学习
  进度。
