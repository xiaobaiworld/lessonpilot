...
涉及任何 UI 时，11 号视觉设计系统是项目级主要参考依据；其完整规则和例外边界见下方入口。
...
| [`design/v1/11-visual-design-system.md`](design/v1/11-visual-design-system.md) | 项目级 UI 视觉标准：四端视觉真源、token、实施路线与防漂移门禁（`D-V1-032`） |
...
已接受的 `D-V1-*` 决策，以及当前性能决策，全部在 [`decisions/`](decisions/)：
...
| `D-V1-032` | [视觉设计系统作为 UI 开发标准](decisions/2026-09-01-visual-design-standard.md)；已接受 |
