...
from sqlalchemy import Column, String, Integer, DateTime, Boolean, ForeignKey, Enum, Text, Index, UniqueConstraint
...
class Lesson(Base):
    ...
    video_reference = relationship('VideoReference', back_populates='lesson', uselist=False, cascade='all, delete-orphan')
