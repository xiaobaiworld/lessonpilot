  ...
  const EXAMPLE_COURSE_PACKAGE = {
    ...
    lessons: [{
      ...
      nodes: [{
        ...
        display: {
          title: '重点提示',
          body: '这是一节关于“把答案说得具体”的互动课。请按下面的顺序学习：\n\n第一个节点是重点提示：先注意示范中的表达差异，理解为什么只说“我很努力”还不够，还要说清楚具体经历、采取的行动和最后的结果。\n\n第二个节点是选择题：回顾前面的提醒，判断哪一个选项真正抓住了“用具体经历回答”的重点。\n\n第三个节点是填空题：从示范表达中找出关键句，练习保留能够说明具体动作和实际结果的词语。\n\n第四个节点是问答题：请用自己的经历说明你如何解决一个困难情况，尝试组织出包含情境、行动和结果的完整回答。\n\n第五个节点是选择题：再次比较两个回答，确认自己能分辨空泛描述和具体经历，进一步巩固本节方法。\n\n接下来一共会有 4 道题：两道选择题、一道填空题和一道问答题。每道题都用来帮助你回顾刚才的表达方法。\n\n本节总结：你需要掌握的不是背下一句固定答案，而是用“情境—行动—结果”的方式，把自己的经历说得具体、可验证、容易理解。\n\n加油。'
        },
        effects: { pause: true },
        evaluation: null
      }, {
