...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "suspended", "archived", name="admin_status"),
            default="active",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "suspended", "archived", name="teacher_status"),
            default="active",
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column(
            "teacher_id", sa.String(36), sa.ForeignKey("v1_teacher_accounts.id"), nullable=False
        ),
        sa.Column("token_digest", sa.String(64), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("expires_at", sa.DateTime(timezone=True), nullable=False),
