...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "available", "superseded", "archived", name="release_status"),
            default="available",
            nullable=False,
        ),
        ...
        sa.Column(
            ...
            sa.String(36),
            sa.ForeignKey("v1_teacher_accounts.id"),
            nullable=False,
        ),
        sa.Column("archived_at", sa.DateTime(timezone=True), nullable=True),
    )
    op.create_unique_constraint(
        "uq_releases_course_number", "v1_course_releases", ["course_id", "release_number"]
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column(
            "release_id", sa.String(36), sa.ForeignKey("v1_course_releases.id"), nullable=False
        ),
    ...
    op.create_unique_constraint(
        "uq_snapshots_release_sequence",
        "v1_release_lesson_snapshots",
        ["release_id", "lesson_sequence"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "release_id",
            sa.String(36),
            sa.ForeignKey("v1_course_releases.id"),
            unique=True,
            nullable=False,
        ),
        sa.Column(
            "availability", sa.String(50), default="published", nullable=False
        ),  # published, draft, paused, recalled
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column(
            "access_code_id", sa.String(36), sa.ForeignKey("v1_access_codes.id"), nullable=False
        ),
        sa.Column(
            "scope",
            sa.Enum("course", "lesson_range", "node_range", name="grant_scope"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_redemptions_proof_hash", "v1_redemptions", ["redeemed_by_client_proof_hash"]
    )
